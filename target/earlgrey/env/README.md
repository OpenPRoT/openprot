...
Test environments are defined using specific rules in [environments.bzl](file:///usr/local/google/home/cfrantz/src/openprot/otdev/target/earlgrey/env/environments.bzl) and instantiated as targets in [BUILD.bazel](file:///usr/local/google/home/cfrantz/src/openprot/otdev/target/earlgrey/env/BUILD.bazel). They communicate configuration details to the runner via the `TestEnvironmentInfo` provider.
...
The following environment targets are defined in [BUILD.bazel](file:///usr/local/google/home/cfrantz/src/openprot/otdev/target/earlgrey/env/BUILD.bazel):
